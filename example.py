...
def format_pokemon(poke, pokemonsJSON, args, ignore, only, pokename):
    ...
    label = \
        ...
        "  <small>" \
        "    <a href='http://www.pokemon.com/us/pokedex/" + pid + "' target='_blank' title='View in Pokedex'>#" + pid + "</a>" \
        "  </small> - " \
        "  <b>" + pokename + "</b> - " \
        "  <small>" \
        "    <a href='http://www.google.com/maps/place/" + str(poke.Latitude) + "," + str(poke.Longitude) + "' target='_blank' title='View in Maps'>Maps</a>" \
        "  </small>" \
        "</div>" \
