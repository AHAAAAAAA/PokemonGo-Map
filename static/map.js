...
function processPokestops(i, item) {
  ...
  if(map_data.pokestops[item.pokestop_id] && map_data.pokestops[item.pokestop_id].dead && item.last_modified > map_data.pokestops[item.pokestop_id].last_modified) {
    if(map_data.pokestops[item.pokestop_id].marker)map_data.pokestops[item.pokestop_id].marker.setMap(null);
    item.marker = setupPokestopMarker(item);
    map_data.pokestops[item.pokestop_id] = item;
  }
}
