...
def parse_config(args):
    ...
    args.username = Config.get('Required', 'username')
    args.password = Config.get('Required', 'password')
    args.location = Config.get('Required', 'location')
    args.step_limit = int(Config.get('Required', 'steps'))
    return args
